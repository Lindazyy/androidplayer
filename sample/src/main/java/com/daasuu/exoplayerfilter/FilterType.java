...
import com.daasuu.epf.filter.GLQuardGridFilter;
...
//    }
    ...
    public static GlFilter createQuardGridGlFilter(int viewNumRow, int viewNumCol, QuardGridFilterCallback quardGridFilterCallback){
        return new GLQuardGridFilter(viewNumRow, viewNumCol, quardGridFilterCallback);
    }
