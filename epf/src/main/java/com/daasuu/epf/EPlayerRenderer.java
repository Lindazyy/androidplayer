...
import com.daasuu.epf.filter.GlInteractPreviewFilter;
...
class EPlayerRenderer extends EFrameBufferObjectRenderer implements SurfaceTexture.OnFrameAvailableListener {
    ...
    EPlayerRenderer(EPlayerView glPreview) {
        ...
        quardGridFilterCallback = null;
    }

    EPlayerRenderer(EPlayerView glPreview, int viewNumPerRow, int viewNumPerCol, QuardGridFilterCallback quardGridFilterCallback) {
        this(glPreview);
    ...
    public void onSurfaceCreated(final EGLConfig config) {
        ...
        if(quardGridFilterCallback == null){
            ...
            previewFilter = new GlInteractPreviewFilter(previewTexture.getTextureTarget(), viewNumPerRow, viewNumPerCol, quardGridFilterCallback);
        }
        previewFilter.setup();
